 ...
 * @author cheta
 */
public class ListAvailablePlanes extends javax.swing.JPanel {

    /**
     * Creates new form ListAvailablePlanes
     */
    private Fleet fleet;
    public ListAvailablePlanes(Fleet fleet) {
        initComponents();
        this.fleet=fleet;
    }
    ...
    private void initComponents() {
        ...
        listAvailTable = new javax.swing.JTable();
        viewListAvailjButton = new javax.swing.JButton();
        ...
        listAvailBTN.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        listAvailBTN.setText("List of All Available Airplanes");
        ...
        listAvailTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(listAvailTable);

        viewListAvailjButton.setText("View");
        viewListAvailjButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                viewListAvailjButtonActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(31, 31, 31)
                        .addComponent(viewListAvailjButton))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(301, 301, 301)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(viewListAvailjButton, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(95, 95, 95)
    ...
    private void viewListAvailjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewListAvailjButtonActionPerformed
        // TODO add your handling code here:
        
       int selectedrow = listAvailTable.getSelectedRow();
        
        if (selectedrow >= 0)
        {
            Airplane A = (Airplane)listAvailTable.getValueAt(selectedrow, 0);
    ...
    }//GEN-LAST:event_viewListAvailjButtonActionPerformed
    ...
    private void listAvailBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listAvailBTNActionPerformed
        ...
        DefaultTableModel dtm = (DefaultTableModel)listAvailTable.getModel();
        dtm.setRowCount(0);
        ...
        for(Airplane airplane : fleet.getFleet()){
            try {
                ...
                Logger.getLogger(ListAvailablePlanes.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private javax.swing.JTable listAvailTable;
    ...
    private javax.swing.JButton viewListAvailjButton;
    // End of variables declaration//GEN-END:variables

    public long getTimeDiff(String departureTime) throws ParseException {
        ...
        return (tempTime.getTimeInMillis() - currentTime);
